...
require ('./include/fonctions_pdf.php');
...
?>
<div align="center">
  <img src="./image/logo.png" id="logoGSB" alt="Laboratoire Galaxy-Swiss Bourdin" title="Laboratoire Galaxy-Swiss Bourdin" /><br/>
</div>
<br/><br/>
<fieldset>
  <div align="left">
  ...
  <div align="right">
    <?php
    signaturePdf($connexion);
    ?>
  </div>


  <?php
  echo'<br/><img src="./image/signature.jpg" align="right">';
  ?>
  <?php
  ...
  $html2pdf->Output('fiche_remboursement.pdf');
  ?>
